	...
	public form() {
		...
		students.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg1) {
				...
				JLabel students_label1 = new JLabel ("Модератор - Сементеев Антон"); // задаем размер
				students_label1.setBounds(20,10,250,30); // задаем размер
				Information.add(students_label1);
				JLabel students_label2 = new JLabel ("Разработчик 1 - Ильясов Максим"); // задаем размер 
				students_label2.setBounds(20,35,250,30); // задаем размер
				Information.add(students_label2); 
				JLabel students_label3 = new JLabel ("Разработчик 2 - Ибрагимов Айдар"); // задаем размер 
				students_label3.setBounds(260,10,250,30); // задаем размер
				Information.add(students_label3);
				JLabel students_label4 = new JLabel ("Разработчик 3 - Сунагатов Ильгиз"); // задаем размер
				students_label4.setBounds(260,35,250,30); // задаем размер
				Information.add(students_label4);
				JLabel students_label5 = new JLabel (""); // задаем размер 
